...
<plist version="1.0">
  <dict>
    ...
    <array>
        <string>/usr/local/Cellar/nginx/1.12.2_1/bin/nginx</string>
        <string>-g</string>
...
https://blog.csdn.net/falcon95/article/details/83625393
...
node sdcm.main.js /Workspace/jxg/cloudy-sdcm-jwt/webapp /Workspace/jxg/logger /Workspace/jxg/upload
  ...
  546  git clone http://gitlab.jixugou.cn/nodeapi/livetctminiapi.git
  547  git clone http://gitlab.jixugou.cn/nodeapi/liveappapi.git
  548  git clone http://gitlab.jixugou.cn/nodeapi/liveh5api.git
  549  ls
  550  cd liveappapi/
  551  clear
  552  ls
  ...
  558  git add *.js
  559  git add *.cfg
  560  git commit -a "init"
  561  git commit -m "init"
