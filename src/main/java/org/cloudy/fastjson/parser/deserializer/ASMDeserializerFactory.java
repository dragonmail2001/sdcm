...
import org.cloudy.fastjson.util.DeserializeBeanInfo;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type)
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", null);
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "deserialzeArrayMapping"
                                          , "(Lorg/cloudy/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;"
                                          , null, null);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanInt", "(C)I");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == long.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanLong", "(C)J");
                mw.visitVarInsn(LSTORE, context.var(fieldInfo.getName() + "_asm", 2));
            } else if (fieldClass == boolean.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanBoolean", "(C)Z");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == float.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFloat", "(C)F");
                mw.visitVarInsn(FSTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == double.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanDouble", "(C)D");
                mw.visitVarInsn(DSTORE, context.var(fieldInfo.getName() + "_asm", 2));
            } else if (fieldClass == char.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanString", "(C)Ljava/lang/String;");
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(fieldClass)));
                mw.visitVarInsn(ALOAD, 1);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getSymbolTable",
                                   "()Lorg/cloudy/fastjson/parser/SymbolTable;");
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanEnum",
                                   "(Ljava/lang/Class;Lorg/cloudy/fastjson/parser/SymbolTable;C)Ljava/lang/Enum;");
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(fieldClass)));
                    mw.visitVarInsn(BIPUSH, seperator);
                    mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanStringArray",
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    if (i == 0) {
                        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "LBRACKET", "I");
                    } else {
                        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "COMMA", "I");
                    }
                    mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "LBRACKET", "I");
                    mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "accept", "(II)V");
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(itemClass)));
                    mw.visitVarInsn(ALOAD, 3);
                    mw.visitMethodInsn(INVOKESTATIC, "org/cloudy/fastjson/util/ASMUtils", "parseArray",
                                       "(Ljava/util/Collection;" //
                                               + "Lorg/cloudy/fastjson/parser/deserializer/ObjectDeserializer;" //
                                               + "Lorg/cloudy/fastjson/parser/DefaultJSONParser;" //
                ...
                if (!last) {
                    ...
                    mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "RBRACKET", "I");
                    mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "EOF", "I");
                }
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "accept", "(II)V");
                continue;
            }
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "COMMA", "I");
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "nextToken", "(I)V");
    ...
    void _deserialze(ClassWriter cw, Context context) {
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.var("lexer"));
            mw.visitMethodInsn(INVOKESPECIAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "isSupportArrayToBean",
                               "(Lorg/cloudy/fastjson/parser/JSONLexer;)Z");
            mw.visitJumpInsn(IFEQ, next_);
            //isSupportArrayToBean
            
            mw.visitVarInsn(ALOAD, context.var("lexer"));
            mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "token", "()I");
            mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "LBRACKET", "I");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanType", "(Ljava/lang/String;)I");

        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONLexerBase", "NOT_MATCH", "I");
        mw.visitJumpInsn(IF_ICMPEQ, super_);

        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getContext",
                           "()Lorg/cloudy/fastjson/parser/ParseContext;");
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "setContext",
                               "(Lorg/cloudy/fastjson/parser/ParseContext;Ljava/lang/Object;Ljava/lang/Object;)Lorg/cloudy/fastjson/parser/ParseContext;");
            mw.visitVarInsn(ASTORE, context.var("childContext"));
        }

        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, "org/cloudy/fastjson/parser/JSONLexerBase", "matchStat", "I");
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONLexerBase", "END", "I");
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class //
                ...
                if (fieldClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, context.var("lexer"));
                    mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "stringDefaultValue",
                                       "()Ljava/lang/String;");
                } else {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldBoolean", "([C)Z");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == byte.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldInt", "([C)I");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldLong", "([C)J");
                mw.visitVarInsn(LSTORE, context.var(fieldInfo.getName() + "_asm", 2));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldFloat", "([C)F");
                mw.visitVarInsn(FSTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldDouble", "([C)D");
                mw.visitVarInsn(DSTORE, context.var(fieldInfo.getName() + "_asm", 2));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldString",
                                   "([C)Ljava/lang/String;");
                mw.visitVarInsn(ASTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldSymbol",
                                   "([CLorg/cloudy/fastjson/parser/SymbolTable;)Ljava/lang/String;");
                mw.visitInsn(DUP);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(fieldClass))); // cast
                    mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "scanFieldStringArray",
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "parseRest",
                           "(Lorg/cloudy/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        mw.visitVarInsn(ALOAD, 2);
        mw.visitVarInsn(ALOAD, 3);
        mw.visitMethodInsn(INVOKESPECIAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "deserialze",
                           "(Lorg/cloudy/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void _isEnable(Context context, MethodVisitor mw, Feature feature) {
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/Feature", feature.name(), "Lorg/cloudy/fastjson/parser/Feature;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "isEnabled", "(Lorg/cloudy/fastjson/parser/Feature;)Z");
    }

    private void defineVarLexer(Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getLexer", "()Lorg/cloudy/fastjson/parser/JSONLexer;");
        mw.visitTypeInsn(CHECKCAST, "org/cloudy/fastjson/parser/JSONLexerBase"); // cast
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 0);
            mw.visitVarInsn(ALOAD, 1);
            mw.visitMethodInsn(INVOKESPECIAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "createInstance",
                               "(Lorg/cloudy/fastjson/parser/DefaultJSONParser;)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, getType(context.getClazz())); // cast
            mw.visitVarInsn(ASTORE, context.var("instance"));
        }
    }
    ...
    private void _setContext(Context context, MethodVisitor mw) {
        ...
        mw.visitVarInsn(ALOAD, context.var("context"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "setContext",
                           "(Lorg/cloudy/fastjson/parser/ParseContext;)V");
        ...
        mw.visitVarInsn(ALOAD, context.var("childContext"));
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/ParseContext", "setObject", "(Ljava/lang/Object;)V");
    ...
    private void _deserialize_endCheck(Context context, MethodVisitor mw, Label reset_) {
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "token", "()I");
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "RBRACE", "I");
        mw.visitJumpInsn(IF_ICMPNE, reset_);
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "matchField", "([C)Z");
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/JSONLexerBase", "token", "()I");
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/JSONToken", "NULL", "I");
        ...
        mw.visitMethodInsn(INVOKEINTERFACE, "org/cloudy/fastjson/parser/deserializer/ObjectDeserializer", "getFastMatchToken", "()I");
        ...
        { // setContext
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "setContext",
                               "(Ljava/lang/Object;Ljava/lang/Object;)Lorg/cloudy/fastjson/parser/ParseContext;");
            mw.visitInsn(POP);
        }
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          "Lorg/cloudy/fastjson/parser/deserializer/ObjectDeserializer;");
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(itemType)));
        mw.visitVarInsn(ILOAD, context.var("i"));
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
        mw.visitMethodInsn(INVOKEINTERFACE, "org/cloudy/fastjson/parser/deserializer/ObjectDeserializer", "deserialze",
                           "(Lorg/cloudy/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, context.var(fieldInfo.getName() + "_asm"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "checkListResolve",
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> itemType) {
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getConfig", "()"
                                                                                         + "Lorg/cloudy/fastjson/parser/ParserConfig;");
        mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(itemType)));
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/ParserConfig", "getDeserializer",
                           "(Ljava/lang/reflect/Type;)Lorg/cloudy/fastjson/parser/deserializer/ObjectDeserializer;");
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getResolveStatus", "()I");
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/DefaultJSONParser", "NeedToResolve", "I");
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getLastResolveTask",
                           "()Lorg/cloudy/fastjson/parser/DefaultJSONParser$ResolveTask;");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "getContext", "()"
                                                                                          + "Lorg/cloudy/fastjson/parser/ParseContext;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser$ResolveTask"
                           , "setOwnerContext"
                           , "(Lorg/cloudy/fastjson/parser/ParseContext;)V");
        ...
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.getName());
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "getFieldDeserializer",
                           "(Ljava/lang/String;)Lorg/cloudy/fastjson/parser/deserializer/FieldDeserializer;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser$ResolveTask", "setFieldDeserializer",
                           "(Lorg/cloudy/fastjson/parser/deserializer/FieldDeserializer;)V");

        mw.visitVarInsn(ALOAD, 1);
        mw.visitFieldInsn(GETSTATIC, "org/cloudy/fastjson/parser/DefaultJSONParser", "NONE", "I");
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/DefaultJSONParser", "setResolveStatus", "(I)V");
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(org.cloudy.fastjson.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
            mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "getFieldType",
    ...
    public FieldDeserializer createStringFieldDeserializer(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo)
...

        {
            MethodVisitor mw = cw.visitMethod(ACC_PUBLIC //
                                              , "<init>" //
                                              , "(Lorg/cloudy/fastjson/parser/ParserConfig;Ljava/lang/Class;Lorg/cloudy/fastjson/util/FieldInfo;)V", null, null);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 2);
            mw.visitVarInsn(ALOAD, 3);
            mw.visitMethodInsn(INVOKESPECIAL, getType(superClass), "<init>"
                               , "(Lorg/cloudy/fastjson/parser/ParserConfig;Ljava/lang/Class;Lorg/cloudy/fastjson/util/FieldInfo;)V");
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/cloudy/fastjson/parser/ParserConfig;Ljava/lang/Class;)V", null, null);
        mw.visitVarInsn(ALOAD, 0);
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, 2);
        mw.visitMethodInsn(INVOKESPECIAL, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "<init>",
                           "(Lorg/cloudy/fastjson/parser/ParserConfig;Ljava/lang/Class;)V");

        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, "org/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "serializer",
                          "Lorg/cloudy/fastjson/parser/deserializer/ASMJavaBeanDeserializer$InnerJavaBeanDeserializer;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "org/cloudy/fastjson/parser/deserializer/JavaBeanDeserializer", "getFieldDeserializerMap",
                           "()Ljava/util/Map;");
        mw.visitInsn(POP);
    ...
    private void _createInstance(ClassWriter cw, Context context) {
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "createInstance"
                                          , "(Lorg/cloudy/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;)Ljava/lang/Object;",
                                          null, null);
